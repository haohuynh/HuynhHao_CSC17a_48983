...
/**
 * This  multiply function should accept a FeetInches object as an argument. The argument object’s
 ...
 * @return 
 */
FeetInches FeetInches::multiply(const FeetInches& fInches) {
    FeetInches result;

    result.feet = feet * fInches.feet;
    result.inches = inches * fInches.inches;
    result.simplify();
